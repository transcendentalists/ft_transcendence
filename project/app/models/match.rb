    ...
    .map { |match|
      {
        ...
        rule: match.rule,
        left_scorecard: match.scorecards.find_by_side("left"),
        right_scorecard: match.scorecards.find_by_side("right"),
        left_user: match.left_user,
        right_user: match.right_user,
