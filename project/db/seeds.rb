...
WarRequest.create([
  {rule_id: 1, bet_point: 10, start_date: DateTime.new(2021,2,14,14), end_date: DateTime.new(2021,1,24,16), war_time: Time.new(1,1,1,10), max_no_reply_count: 10, include_ladder: true, include_tournament: true, target_match_score: 3, status: "pending"},
  {rule_id: 2, bet_point: 20, start_date: DateTime.new(2021,2,15,15), end_date: DateTime.new(2021,1,24,17), war_time: Time.new(1,1,1,1), max_no_reply_count: 5, include_ladder: false, include_tournament: true, target_match_score: 5, status: "approved"},
  {rule_id: 3, bet_point: 30, start_date: DateTime.new(2021,2,16,16), end_date: DateTime.new(2021,1,24,18), war_time: Time.new(1,1,1,12), max_no_reply_count: 1, include_ladder: true, include_tournament: false, target_match_score: 7, status: "approved"},
  {rule_id: 4, bet_point: 40, start_date: DateTime.new(2021,2,17,17), end_date: DateTime.new(2021,1,24,19), war_time: Time.new(1,1,1,19), max_no_reply_count: 3, include_ladder: true, include_tournament: true, target_match_score: 10, status: "approved"},
