...
WarRequest.create([
  {rule_id: 1, bet_point: 100, start_date: Time.zone.tomorrow.midnight, end_date: Time.zone.now.change({ year: 2021, month: 3, day: 20 }), war_time: Time.zone.now.change({ hour: 10 }), max_no_reply_count: 3, include_ladder: true, include_tournament: true, target_match_score: 3, status: "accepted"},
  ...
  {rule_id: 6, bet_point: 100, start_date: Time.zone.now.change({ year: 2021, month: 3, day: 31 }).midnight, end_date: Time.zone.now.change({ year: 2021, month: 4, day: 6 }).midnight, war_time: Time.zone.now.change({ hour: 16 }), max_no_reply_count: 10, include_ladder: true, include_tournament: false, target_match_score: 3, status: "accepted"},
