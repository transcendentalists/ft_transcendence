...
WarStatus.create([
  ...
  {guild_id: 1, war_request_id: 4, position: "challenger"},
  {guild_id: 2, war_request_id: 4, position: "enemy"},
  {guild_id: 3, war_request_id: 5, position: "challenger"},
  {guild_id: 2, war_request_id: 5, position: "enemy"},
  {guild_id: 4, war_request_id: 6, position: "challenger"},
  {guild_id: 2, war_request_id: 6, position: "enemy"},
  {guild_id: 4, war_request_id: 7, position: "challenger"},
  {guild_id: 3, war_request_id: 7, position: "enemy"},
  {guild_id: 2, war_request_id: 8, position: "challenger"},
  {guild_id: 3, war_request_id: 8, position: "enemy"},
])
