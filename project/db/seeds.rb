...
Guild.create([
  ...
  {owner_id: 2, name: "GON42seoul", anagram: "@GON4", image_url: "assets/gon.png", point: 1500},
...
WarRequest.create([
  {rule_id: 1, bet_point: 1000, start_date: DateTime.new(2021,3,21,14), end_date: DateTime.new(2021,3,24,16), war_time: Time.new(1,1,1,10), max_no_reply_count: 3, include_ladder: true, include_tournament: true, target_match_score: 3, status: "accepted"},
  {rule_id: 2, bet_point: 1000, start_date: DateTime.new(2021,3,22,15), end_date: DateTime.new(2021,3,24,17), war_time: Time.new(1,1,1,1), max_no_reply_count: 4, include_ladder: false, include_tournament: true, target_match_score: 5, status: "pending"},
  {rule_id: 3, bet_point: 1000, start_date: DateTime.new(2021,3,23,16), end_date: DateTime.new(2021,3,24,18), war_time: Time.new(1,1,1,12), max_no_reply_count: 5, include_ladder: true, include_tournament: false, target_match_score: 7, status: "pending"},
  {rule_id: 4, bet_point: 1000, start_date: DateTime.new(2021,3,24,17), end_date: DateTime.new(2021,3,24,19), war_time: Time.new(1,1,1,19), max_no_reply_count: 6, include_ladder: true, include_tournament: true, target_match_score: 10, status: "pending"},
  {rule_id: 5, bet_point: 1000, start_date: DateTime.new(2021,3,10,18), end_date: DateTime.new(2021,3,20,20), war_time: Time.new(1,1,1,10), max_no_reply_count: 6, include_ladder: false, include_tournament: false, target_match_score: 3, status: "pending"},
  {rule_id: 6, bet_point: 1000, start_date: DateTime.new(2021,3,12,19), end_date: DateTime.new(2021,3,22,21), war_time: Time.new(1,1,1,12), max_no_reply_count: 3, include_ladder: true, include_tournament: true, target_match_score: 5, status: "pending"},
  {rule_id: 7, bet_point: 1000, start_date: DateTime.new(2021,3,14,20), end_date: DateTime.new(2021,3,24,22), war_time: Time.new(1,1,1,10), max_no_reply_count: 9, include_ladder: true, include_tournament: true, target_match_score: 7, status: "pending"},
  {rule_id: 1, bet_point: 1000, start_date: DateTime.new(2021,3,16,10), end_date: DateTime.new(2021,3,16,20), war_time: Time.new(1,1,1,11), max_no_reply_count: 10, include_ladder: false, include_tournament: false, target_match_score: 10, status: "pending"},
  {rule_id: 2, bet_point: 1000, start_date: DateTime.new(2021,3,16,12), end_date: DateTime.new(2021,3,16,14), war_time: Time.new(1,1,1,2), max_no_reply_count: 3, include_ladder: false, include_tournament: false, target_match_score: 3, status: "pending"},
  {rule_id: 3, bet_point: 1000, start_date: DateTime.new(2021,3,16,14), end_date: DateTime.new(2021,3,24,22), war_time: Time.new(1,1,1,5), max_no_reply_count: 5, include_ladder: false, include_tournament: true, target_match_score: 5, status: "accepted"},
  {rule_id: 4, bet_point: 1000, start_date: DateTime.new(2021,3,16,16), end_date: DateTime.new(2021,3,25,23), war_time: Time.new(1,1,1,9), max_no_reply_count: 8, include_ladder: true, include_tournament: false, target_match_score: 7, status: "accepted"},
  {rule_id: 5, bet_point: 1000, start_date: DateTime.new(2021,3,16,18), end_date: DateTime.new(2021,3,16,24), war_time: Time.new(1,1,1,10), max_no_reply_count: 10, include_ladder: false, include_tournament: true, target_match_score: 10, status: "accepted"},
  {rule_id: 6, bet_point: 1000, start_date: DateTime.new(2021,3,16,20), end_date: DateTime.new(2021,3,16,23), war_time: Time.new(1,1,1,11), max_no_reply_count: 10, include_ladder: true, include_tournament: false, target_match_score: 3, status: "accepted"},
  {rule_id: 7, bet_point: 1000, start_date: DateTime.new(2021,3,16,21), end_date: DateTime.new(2021,3,24,20), war_time: Time.new(1,1,1,14), max_no_reply_count: 10, include_ladder: false, include_tournament: true, target_match_score: 5, status: "accepted"},
  {rule_id: 1, bet_point: 1000, start_date: DateTime.new(2021,3,14,21), end_date: DateTime.new(2021,3,24,21), war_time: Time.new(1,1,1,11), max_no_reply_count: 10, include_ladder: true, include_tournament: false, target_match_score: 3, status: "accepted"},
  {rule_id: 2, bet_point: 1000, start_date: DateTime.new(2021,3,15,21), end_date: DateTime.new(2021,3,24,22), war_time: Time.new(1,1,1,14), max_no_reply_count: 10, include_ladder: false, include_tournament: true, target_match_score: 5, status: "accepted"},
  {rule_id: 3, bet_point: 1000, start_date: DateTime.new(2021,3,16,21), end_date: DateTime.new(2021,3,24,23), war_time: Time.new(1,1,1,11), max_no_reply_count: 10, include_ladder: true, include_tournament: false, target_match_score: 3, status: "accepted"},
  {rule_id: 4, bet_point: 1000, start_date: DateTime.new(2021,3,28,21), end_date: DateTime.new(2021,3,30,23), war_time: Time.new(1,1,1,14), max_no_reply_count: 10, include_ladder: false, include_tournament: true, target_match_score: 5, status: "accepted"},
