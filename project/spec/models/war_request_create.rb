...
RSpec.describe User, type: :model do
  ...
  # it "cannot be created with invalid war_time" do
  # war_request_hash[:end_date] = Date.new
  # war_request = WarRequest.create(war_request_hash)
  # expect(war_request.id.nil?).to eq(true)
  # war_request_hash[:end_date] = Date.tomorrow + 5.days
  # end
  ...
  # it "cannot be created with invalid include_ladder, tournament" do
  # params = war_request_hash.clone
  # params[:include_ladder] = 199
  # war_request = WarRequest.new(params)
  # expect(war_request.valid?).to eq(false)
  # end
